...
public class StationInfoPane extends InfoPane{
	...
	protected void displayData() {
		if (t instanceof Station) {
			...
			id.setText(station.getStationID());
			name.setText(station.getStationName());
			address.setText(station.getStationAddress());
			bike.setText(Integer.toString(station.getC_Bike()));
			ebike.setText(Integer.toString(station.getC_EBike()));
			tbike.setText(Integer.toString(station.getC_TBike()));
		}
